# LearnOS: A Beginner's Guide to Your Operating System
...
When your computer starts, it doesn't know what an "Operating System" is. It follows a strict set of rules:
...
4. It starts executing those 512 bytes. This is your **Bootloader**.

---

## 2. The Bootloader ([boot/boot.asm](file:///home/farhan/Desktop/Learning/LearnOS/boot/boot.asm))

Your bootloader is like a "starter motor." Its job is to load the actual engine (the Kernel).
...
## 3. The Global Descriptor Table ([boot/gdt.asm](file:///home/farhan/Desktop/Learning/LearnOS/boot/gdt.asm))
...
## 4. The Bridge ([kernel/kernel_entry.asm](file:///home/farhan/Desktop/Learning/LearnOS/kernel/kernel_entry.asm))
...
- It calls [kernel_main](file:///home/farhan/Desktop/Learning/LearnOS/kernel/kernel.c#24-33) (the C function).

---

## 5. The Kernel ([kernel/kernel.c](file:///home/farhan/Desktop/Learning/LearnOS/kernel/kernel.c))
...
- **[clear_screen()](file:///home/farhan/Desktop/Learning/LearnOS/kernel/kernel.c#7-13)**: Fills the VGA area with spaces to clear the old BIOS messages.
- **[print_string()](file:///home/farhan/Desktop/Learning/LearnOS/kernel/kernel.c#14-23)**: Copies characters into the VGA memory to show "LearnOS Kernel: System Booted Successfully!".

---

## 6. The Linker ([kernel/linker.ld](file:///home/farhan/Desktop/Learning/LearnOS/kernel/linker.ld))
...
## 7. The Build System ([Makefile](file:///home/farhan/Desktop/Learning/LearnOS/Makefile))

The [Makefile](file:///home/farhan/Desktop/Learning/LearnOS/Makefile) is your automation tool. It handles:
1. **Assembling** [.asm](file:///home/farhan/Desktop/Learning/LearnOS/boot/gdt.asm) files using `nasm`.
2. **Compiling** [.c](file:///home/farhan/Desktop/Learning/LearnOS/kernel/kernel.c) files using `gcc`.
